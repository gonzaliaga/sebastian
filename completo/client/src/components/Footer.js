            ...
            <footer class="bg-white dark:bg-gray-900">
                <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    <div class="md:flex md:justify-between">
                        <div class="mb-6 md:mb-0">
                            <a href="" class="flex items-center">
                                <img src={require('../assets/kapo-logo.png')} class="h-8 me-3" alt="acato Logo" />
                                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Kapodipelo</span>
                            </a>
                        </div>
                        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                            ...
                            <div>
                                ...
                                <ul class="text-gray-500 dark:text-gray-400 font-medium">
                                    <li class="mb-2">
                                        <a href="#" class="hover:underline">Pedro de valdivia 1423, Providencia. Santiago, Chile.</a>
                                    </li>
                                    <li class="mb-3">
                                        <a href="#" class="hover:underline">Teléfono: 22 569 4326.</a>
                                    </li>
                                    <li class="mb-3">
                                        <a href="#" class="hover:underline">Correo: ventas@kapodipelo.cl.</a>
                                    </li>
                                    <li class="mb-3">
                                        <a href="#" class="hover:underline">Horario: 10:00 a 18:00 horas.</a>
                                    </li>
                                </ul>
                            </div>
                            <div>
                                ...
                                <ul class="text-gray-500 dark:text-gray-400 font-medium">
                                    <li class="mb-3">
                                        <a href="#" class="hover:underline ">Políticas de despacho</a>
                                    </li>
                                    <li class="mb-3">
                                        <a href="#" class="hover:underline">Garantía del producto</a>
                                    </li>
                                    <li class="mb-3">
                    ...
                    <div class="sm:flex sm:items-center sm:justify-between">
                        <span class="text-lg text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" class="hover:underline">Kapodipelo</a>. Todos los iquierdos reservados.
                        </span>
